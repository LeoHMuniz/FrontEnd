    ...
    <div className="max-w-[1200px] mx-auto flex items-center justify-between">
      ...
      <div className="flex items-center gap-3">
        <div className="flex flex-col items-end gap-0.5">
          <span className="text-sm font-medium">Leo Muniz</span>
          <span className="text-xs text-zinc-400">leo-henriquesantos@hotmail.com</span>
        </div>
        <img
          src="https://avatars.githubusercontent.com/u/132720449?v=4"
